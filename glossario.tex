...
% description={\textit{pattern} che consente di isolare l'\textit{application}/\textit{business layer} dal \textit{persistence layer} (di solito un \textit{database} relazionale, ma potrebbe essere qualsiasi altro meccanismo di persistenza)}
