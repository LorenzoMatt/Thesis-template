...
\begin{subusecase}{Visualizzazione obbiettivi del gruppo}
    ...
    \usecasescenarioprincipale{
        L'utente dalla schermata dei gruppi ha deciso di visualizzare i
        dettagli di un gruppo, e dalla schermata di visualizzazione dei
        dettagli di un gruppo visualizza gli obbiettivi di un
        gruppo.
    }
\end{subusecase}
...
\begin{subusecase}{Modifica obbiettivi del gruppo}
    ...
    \usecasescenarioprincipale{
        ...
        obbiettivi di un gruppo dalla schermata di modifica dei gruppi.
    }
\end{subusecase}
...
\begin{subusecase}{Inserimento obbiettivi del gruppo}
    ...
    \usecasescenarioprincipale{
        ...
        obbiettivi del gruppo dalla schermata di creazione di un gruppo.
    }
\end{subusecase}
...
\begin{usecase}{Visualizzazione lista delle will degli utenti appartenenti agli
    ...
    \usecasescenarioprincipale{
        ...
        nella finestra di visualizzazione della lista delle \textit{will} degli
        utenti
...
\begin{subusecase}{Visualizzazione singola will in lista}
    ...
    \usecasescenarioprincipale{
        ...
        lista
        delle \textit{will} degli utenti appartenenti agli stessi gruppi a cui
        partecipa l'utente e visualizza una \textit{will} da questa lista.
    }
\end{subusecase}
...
\begin{subsubusecase}{Visualizzazione nome del proprietario}
    ...
    \usecasescenarioprincipale{
        ...
        \textit{will} dalla lista delle \textit{will}.
    }
\end{subsubusecase}
