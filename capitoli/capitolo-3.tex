...
\begin{subsubsubusecase}{Visualizzazione singolo partecipante in lista}
    ...
    \usecasedesc{L'utente vuole visualizzare il nome e cognome di un partecipante dalla lista dei partecipanti}
    \usecasepost{L'utente ha visualizzato il nome e cognome di un partecipante dalla lista dei partecipanti}
    \usecasescenarioprincipale{
        \begin{enumerate}[nolistsep]
            \item L'utente ha visualizza il nome e cognome di un partecipante dalla lista dei partecipanti.
        \end{enumerate}
    }
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=1\columnwidth]{usecase/sottocasi UC6.png} 
...
\begin{subusecase}{Inserimento nome del gruppo}
    ...
    \usecasedesc{L'utente vuole inserire il nome di un gruppo}
    \usecasepost{L'utente ha inserito il nome di un gruppo}
    \usecasescenarioprincipale{
        \begin{enumerate}[nolistsep]
            \item L'utente inserisce il nome di un gruppo.
        \end{enumerate}
    }
\end{subusecase}
...
\begin{subusecase}{Inserimento descrizione del gruppo}
    ...
    \usecaseactors{Utente autenticato}
    \usecasepre{L'utente ha aperto la \textit{web-app}, è autenticato e sta creando un nuovo gruppo}
    \usecasedesc{L'utente vuole inserire la descrizione di un gruppo}
    \usecasepost{L'utente ha inserito la descrizione di un gruppo}
    \usecasescenarioprincipale{
        \begin{enumerate}[nolistsep]
            \item L'utente inserisce la descrizione di un gruppo.
        \end{enumerate}
    }
\end{subusecase}
...
\begin{subusecase}{Inserimento obbiettivi del gruppo}
    ...
    \usecaseactors{Utente autenticato}
    \usecasepre{L'utente ha aperto la \textit{web-app}, è autenticato e sta creando un nuovo gruppo}
    \usecasedesc{L'utente vuole inserire gli obbiettivi di un gruppo}
    \usecasepost{L'utente ha inserito gli obbiettivi di un gruppo}
    \usecasescenarioprincipale{
        \begin{enumerate}[nolistsep]
            \item L'utente inserisce gli obbiettivi di un gruppo.
        \end{enumerate}
    }
\end{subusecase}
...
\begin{subusecase}{Inserimento numero massimo di utenti nel gruppo}
    ...
    \usecaseactors{Utente autenticato}
    \usecasepre{L'utente ha aperto la \textit{web-app}, è autenticato e sta creando un nuovo gruppo}
    \usecasedesc{L'utente vuole inserire il numero massimo di utenti nel gruppo}
    \usecasepost{L'utente ha inserito il numero massimo di utenti nel gruppo}
    \usecasescenarioprincipale{
        \begin{enumerate}[nolistsep]
            \item L'utente inserisce il numero massimo di utenti nel gruppo.
        \end{enumerate}
    }
\end{subusecase}
...
\begin{subusecase}{Inserimento località del gruppo}
    ...
    \usecaseactors{Utente autenticato}
    \usecasepre{L'utente ha aperto la \textit{web-app}, è autenticato e sta creando un nuovo gruppo}
    \usecasedesc{L'utente vuole inserire la località di un gruppo}
    \usecasepost{L'utente ha inserito la località di un gruppo}
    \usecasescenarioprincipale{
        \begin{enumerate}[nolistsep]
            \item L'utente inserisce la località di un gruppo.
        \end{enumerate}
    }
\end{subusecase}
