...
\begin{figure}[H] 
    \centerline{\includegraphics[scale=0.6]{sito/crea-gruppo.png}}     
...
\begin{figure}[H] 
    \centerline{\includegraphics[scale=0.7]{sito/modifica-gruppo.png}} 
...
\myparagraph{Metodi}
\begin{itemize}
    \item \class{getPartecipants}: ottiene gli utenti che partecipano al gruppo;
...
\myparagraph{WillDataService}
\label{par:WillDataService}
