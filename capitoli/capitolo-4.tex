...
Tutte queste classi estendono l'interfaccia \code{JpaRepository<T,ID>}, dove T è il tipo della classe da mappare, ed ID è il tipo dell'identificativo della classe mappata.\\
...
\myparagraph{CrewRepository}
% TODO: aggiungere immagine della classe
\label{CrewRepository}
Classe con funzionalità \gls{JPA} che permette di mappare la classe \class{Crew} in una tabella di un \textit{database} relazionale, svolgendo anche il compito \gls{EntityManager}, effettuando operazioni di recupero, ricerca ed eliminazione dei gruppi.\\ 





\myparagraph{JointUtentiCrewRepository}
% TODO: aggiungere immagine della classe
Classe con funzionalità \gls{JPA} che permette di mappare la classe \class{JointUtentiCrew} in una tabella di un \textit{database} relazionale, svolgendo anche il compito \gls{EntityManager}, effettuando operazioni di recupero, ricerca ed eliminazione dei gruppi. 

\label{JointUtentiCrewRepository}
\myparagraph{JointUsciteCrewRepository}
% TODO: aggiungere immagine della classe
