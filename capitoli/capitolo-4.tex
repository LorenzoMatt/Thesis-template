...
Tuttora anche i nuovi prodotti fanno affidamento su Java.
...
\noindent È un \gls{superset} di JavaScript, poiché permette di aggiungere la
tipizzazione
...
dinamiche utilizzato per la creazione di \gls{spa} e
...
\textit{web} attraenti, coerenti e funzionali.
...
questo \textit{component} è possibile inserire diversi altri \textit{component}
...
grafica delle nuove maschere da aggiungere a \productName. A partire da
...
dell'architettura \textit{software} secondo il quale questi ultimi sono
...
più istanze di un singolo \gls{microservizio} coesistano, in alcuni casi
...
fornite.\\
Angular include un meccanismo di \textit{Dependency Injection} solido e
...
momento in cui effettivamente vengono utilizzati, tenendo così bassa la
...
\textit{web app} non verrà descritto.
