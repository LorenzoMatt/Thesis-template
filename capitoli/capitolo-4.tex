...
sufficiente utilizzare l'annotazione \code{@Autowired}.\cite{site-dependency-injection-spring}
% \begin{figure}[H] 
%     \centering 
...
\begin{itemize}
    ...
    \item  si inietta il servizio e lo si utilizza ovunque sia necessario. \cite{site-dependency-injection-angular}
          % \begin{figure}[H] 
          %     \centering 
