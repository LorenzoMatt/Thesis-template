...
\begin{itemize}
      \item la prima è un insieme di attività che sono legate al \textit{back
            ...
            In particolare:
            \begin{enumerate}
                  \item il primo \gls{microservizio} consente l'effettuazione
                        delle
                  ...
                  \item il terzo è l'implementazione di un \gls{Eureka Server}
                        che
            ...
            \gls{containerizzazione} di tutti i \glspl{microservizio} su
            Docker.
