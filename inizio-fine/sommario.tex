...
\begin{itemize}
      \item la prima è un insieme di attività che sono legate al \textit{back
            ...
            \begin{enumerate}
                  \item il primo \gls{microservizio} consente l'effettuazione delle
                        funzionalità \gls{CRUD} per la gestione dei gruppi e la
                        visualizzazione delle
                        \gls{will}
                        degli utenti appartenenti allo stesso gruppo;
                  \item il secondo è l'implementazione di un
                        \nameref{sub:ApiGateway}, che permette di esporre le
            ...
            \end{enumerate}
            Oltre all'implementazione di nuovi \glspl{microservizio}, quelli
            esistenti
      ...
      \item La seconda attività è stata la modifica del \textit{front end},
            mediante il \gls{framework} Angular, per adeguarla alle nuove
            funzionalità del
            \textit{back end}.
\end{itemize}
