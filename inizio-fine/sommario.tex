...
\begin{itemize}
    ...
    In particolare: 
        \begin{enumerate}
            ...
            \item il secondo è l'implementazione di un \nameref{sub:ApiGateway}, che permette di esporre le \gls{API} dei vari servizi presenti in un 
        ...
        \end{enumerate}
    Oltre all'implementazione di nuovi microservizi, quelli esistenti sono stati modificati affinché le \gls{will} possano
    ...
    \item La seconda attività è stata la modifica del \textit{front end}, mediante il \gls{framework} \gls{Angular}, per adeguarla alle nuove funzionalità del \textit{back end}.
\end{itemize}
